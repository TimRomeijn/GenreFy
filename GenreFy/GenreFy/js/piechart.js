...
//Hide the variables on the page
$("#rock").hide();
$("#hiphop").hide();
$("#techno").hide();
$("#jazz").hide();
...
//Last session you played
$(document).ready(function () {
    $(".lastSession").piechart([
		["Nummers", "songs you liked"],
		["Rock", parseInt($("#rock").html())],
        ["Hiphop", parseInt($("#hiphop").html())],
		["Techno", parseInt($("#techno").html())],
        ["Jazz", parseInt($("#jazz").html())],
		["Classic", parseInt($("#classic").html())],
		["Country", parseInt($("#country").html())],
...
$(document).ready(function () {
    //Put the values in the chart
    $(".totalSession").piechart([
		["Nummers", "songs you liked"],
		["Rock", parseInt($("#rock").html())],
        ["Hiphop", parseInt($("#hiphop").html())],
		["Techno", parseInt($("#techno").html())],
