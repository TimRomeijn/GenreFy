<?php
include('../custom/login.php'); // Includes Login Script
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form action="" method="post">
                            ...
                            <hr />
                            <button type="button" name="button" class="btn btn-success" onclick="location.href = 'createAccount.php'">Register</button>
