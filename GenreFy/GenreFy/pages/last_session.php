...
$result = "SELECT * FROM genrefy_session WHERE gebruiker = '$user_check' ORDER BY session_id DESC LIMIT 1";
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navHeaderCollapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="#"><img src="../img/Menu_Icons/2.png" class="menu_icon">Last Session</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="page-header">
                    <h1 id="header">Your latest session with Genre-fy tells us: <br />
                    <small>your favourite genre is <?php echo $genres[$highest_number]; ?></small></h1>
                </div>
                <div id="content">
                   <div class="framework-container">
                    <div class="lastSession" onpagenavigation id="demo"></div>
                  </div>
               </div>
           </div>
        </div>
